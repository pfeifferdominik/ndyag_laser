...
\section{Realtive Absorption des Nd:YAG}
...
\section{Arbeitsgerade der Laserdiode}
...
\section{Kennlinie der Laserdiode}
...
\section{Einbau und charakterisierung des KTP}
...
\section{Kommerzieller Laserpointer}
...
\end{equation}
Bei einer elektrischen Leitung von $P_{Pump}=I_{Pump}\cdot V=199,6\,\si{mA}\cdot 2,88\,\si{V}=574,85\,\si{mW}$ ergibt sich damit eine Effizienz von $\eta=\frac{P_{Pointer}}{P_{Pump}}=0,184\pm0,003 \%$. Vergleicht man dies mit dem im Versuch aufgebauten Lasersystem mit einer Effizienz von $\eta=\frac{P_{Photo}}{P_{Pump}}=Zahl \%$\\
$\cdots$
\chapter{Fazit}
\chapter{Messdaten}
